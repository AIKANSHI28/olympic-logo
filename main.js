...
ctx.lineWidth = 5;
ctx.arc(x=150, y=143, r=40, startAngle=0,2 * Math.PIendAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x=350, y=210, r=40, startAngle=0,2 * Math.PIendAngle);
ctx.stroke();
...
ctx.strokestyle = "red";
ctx.lineWidth = 5;
ctx.arc(x=210, y=40, r=40, startAngle=0,2 * Math.PIendAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x=150, y=300, r=250, startAngle=0,2 * Math.PIendAngle);
ctx.stroke();
...
ctx.lineWidth = 5;
ctx.arc(x=400, y=250, r=40, startAngle=0,2 * Math.PIendAngle);
ctx.stroke();